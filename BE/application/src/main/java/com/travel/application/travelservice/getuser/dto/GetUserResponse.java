package com.travel.application.travelservice.getuser.dto;
...
public class GetUserResponse {
	...
	public GetUserResponse(Long userID, String userName, String password, Date createTime, Date modifyTime,
			Long roleID) {
		this.userID = userID;
